...
class AtQueryDockWidget(QtWidgets.QDockWidget):
    ...
    def _send_query(self):
        ...
        try:
            ...
            QgsMessageLog.logMessage(f"Ollama Contact Error: {traceback.format_exc()}", 'AtQuery', QgsMessageLog.Level.Critical)
    ...
    def handle_tool_call(self, tool_call_json):
        ...
        if self.iface is None:
            QgsMessageLog.logMessage("iface is not set!", 'AtQuery', QgsMessageLog.Level.Critical)
    ...
    def execute_code(self, code_text):
        ...
        try:
            ...
            QgsMessageLog.logMessage(f"PyQGIS Execution Error: {traceback.format_exc()}", 'AtQuery', QgsMessageLog.Level.Critical)
