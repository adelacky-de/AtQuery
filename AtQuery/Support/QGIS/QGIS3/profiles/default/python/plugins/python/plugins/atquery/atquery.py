...
class AtQuery:
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/atquery/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'AtQuery'),
            callback=self.run,
