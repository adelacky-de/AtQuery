...
| **VectorProcessing** | buffer, clip, reproject, join, merge, dissolve, extract, difference, split, fix, convex hull, polygons, lines, centroid, intersection, bounding box, geometry, union, simplify, smooth, snap, multipart, singlepart | Core vector geoprocessing algorithms. |
| **RasterAnalysis** | slope, hillshade, aspect, raster, dem, elevation, calculator, mask, grid, terrain model, digital elevation | Tools for processing and analyzing raster data. |
| **WebServices** | wms, wfs, xyz, tiles, google maps, osm, remote, server, online, openstreetmap, basemap, background layer | Adding layers from web-based services. |
| **TerrainAnalysis** | tin, idw, interpolation, contours, relief, rugosity, surface, terrain | Advanced terrain and surface modeling. |
| **ExportTools** | export, save, save as, pdf, csv, geojson, shapefile, database, png, image, output, write, download, geopackage, kml | Exporting layers and map layouts to files. |
