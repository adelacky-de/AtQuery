...
| **DataInspection** | fields, attributes, columns, crs, projection, coordinate system, data, rows, records, values, table, metadata, schema | Detailed metadata about layers and their structures. |
