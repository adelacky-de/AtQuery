...
| **VectorProcessing** | buffer, clip, reproject, join, merge, dissolve, extract, difference, split, fix, convex hull, polygons, lines, centroid, intersection | Core vector geoprocessing algorithms. |
